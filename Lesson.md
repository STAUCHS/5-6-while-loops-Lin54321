...
Why?
> Because the guess is not being updated, so the while is always checking if the guess is not equal to my_num. Since this will always be true, the body funs forever. 
